...
class cartesian_grid:
    ...
    def init(self, size=None, multigrid=None, multi_coord=None, measurements=None):
        ...
        # self.degraded_list=tm.Degraded_list
    ...
    def rl_init(self):
        ...
        reward_accumulator.init(self, self.severity)
    ...
    def step(self, action):
        ...
        # Reward
        reward = reward_accumulator.main(self, self.severity)
        ...
        # if self.mode == 'eval' and self.timestep >62:
            # pdb.set_trace()
